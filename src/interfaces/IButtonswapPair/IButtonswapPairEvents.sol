...
interface IButtonswapPairEvents is IButtonswapERC20Events {
     ...
     */
    event Mint(address indexed from, uint256 amount0, uint256 amount1, address indexed to);
     ...
     */
    event Burn(address indexed from, uint256 amount0, uint256 amount1, address indexed to);
