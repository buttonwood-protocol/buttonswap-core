...
interface IButtonswapPair is IButtonswapPairErrors, IButtonswapPairEvents, IButtonswapERC20 {
     ...
     */
    function maxVolatilityBps() external view returns (uint256 _maxVolatilityBps);
     ...
     */
    function setMaxVolatilityBps(uint256 _maxVolatilityBps) external;

    /**
     * @notice How long the minimum singled-sided timelock lasts for.
     * @return _minTimelockDuration The value of minTimelockDuration
     */
    function minTimelockDuration() external view returns (uint256 _minTimelockDuration);
     ...
     */
    function setMinTimelockDuration(uint256 _minTimelockDuration) external;

    /**
     * @notice How long the maximum singled-sided timelock lasts for.
     * @return _maxTimelockDuration The value of maxTimelockDuration
     */
    function maxTimelockDuration() external view returns (uint256 _maxTimelockDuration);
     ...
     */
    function setMaxTimelockDuration(uint256 _maxTimelockDuration) external;
     ...
     */
    function maxSwappableReservoirLimitBps() external view returns (uint256 _maxSwappableReservoirLimitBps);
     ...
     */
    function setMaxSwappableReservoirLimitBps(uint256 _maxSwappableReservoirLimitBps) external;
     ...
     */
    function swappableReservoirGrowthWindow() external view returns (uint256 _swappableReservoirGrowthWindow);
     ...
     */
    function setSwappableReservoirGrowthWindow(uint256 _swappableReservoirGrowthWindow) external;
